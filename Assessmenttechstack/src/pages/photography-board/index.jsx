  ...
  return (
    <div className="min-h-screen p-4 bg-slate-50">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
        <h1 className="text-3xl font-bold text-gray-800">Photography Board</h1>
      ...
      {status === "loading" && (
        <div className="mb-6 p-4 rounded-lg bg-white border border-gray-200 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-600">Loading photography ideas from MongoDB…</span>
          </div>
        </div>
      )}
      ...
      {resources.length === 0 && status !== "loading" ? (
        <div className="bg-white rounded-lg shadow p-8 text-center">
          <p className="text-gray-500 text-lg">No photography ideas yet. Be the first to share!</p>
          <button
            onClick={() => setShowModal(true)}
