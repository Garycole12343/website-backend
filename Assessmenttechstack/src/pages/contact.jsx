        ...
        <form onSubmit={handleSubmit} className="bg-card p-8 rounded-2xl shadow-xl space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            <label className="block text-sm font-semibold text-muted-foreground mb-2">Inquiry Type *</label>
            <select
              name="inquiryType"
