      ...
      <div className="space-y-4">
        {settings?.map((setting) => (
          ...
          >
            ...
            <button
              onClick={() => onPrivacyChange(setting?.id)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-pointer ${
