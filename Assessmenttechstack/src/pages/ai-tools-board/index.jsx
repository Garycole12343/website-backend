    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-card p-6 rounded shadow-lg w-full max-w-md">
        ...
        <form onSubmit={onSubmit}>
          ...
          <input
            placeholder="Optional Link (e.g., website, GitHub repo)"
            value={newIdea.link}
...
function AiToolsBoard() {
  ...
  const resources = aiToolsBoard?.aiToolsResources || [];
  ...
  useEffect(() => {
    ...
    console.log("AI Tools Resources:", resources);
    ...
    <div className="min-h-screen bg-background p-4">
      ...
      {status === "loading" && (
        <div className="mb-6 p-4 rounded-lg bg-card border border-border shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="text-muted-foreground">Loading AI tools from MongoDB…</span>
          </div>
        </div>
      )}
      ...
      {error && (
        <div className="mb-6 p-4 rounded-lg bg-red-50 border border-red-200 text-red-700">
          ...
          <button 
            onClick={() => dispatch(fetchAiToolsResources())}
      ...
      {resources.length === 0 && status !== "loading" ? (
        <div className="bg-card rounded-lg shadow p-8 text-center">
          <p className="text-muted-foreground text-lg">No AI tools added yet. Be the first to share!</p>
          <button
            onClick={() => setShowModal(true)}
