...
import { addCodingResource, updateCodingLike } from "../../store/slices/codingBoardSlice";
...
function CodingBoard() {
  ...
  useEffect(() => {
    saveState("codingBoard", board);
  }, [board]);

  const handleAddIdea = (e) => {
    e.preventDefault();
    dispatch(addCodingResource({ ...newIdea, id: Date.now() }));
    setNewIdea({
      title: "",
      description: "",
      link: "",
  ...
  const handleLike = (id) => dispatch(updateCodingLike(id));
  ...
  return (
    <div className="min-h-screen p-4">
      <h1 className="text-3xl mb-4">Coding Board</h1>
