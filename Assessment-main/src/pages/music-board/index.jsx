...
import { addMusicResource, updateMusicResourceLike } from "../../store/slices/musicBoardSlice";
...
function MusicBoard() {
  ...
  useEffect(() => {
    saveState("musicBoard", board);
  }, [board]);

  const handleAddIdea = e => {
    e.preventDefault();
    dispatch(addMusicResource({ ...newIdea, id: Date.now() }));
    setNewIdea({
      title: "",
      description: "",
      link: "",
  ...
  const handleLike = id => dispatch(updateMusicResourceLike(id));
  ...
  return (
    <div className="min-h-screen p-4">
      <h1 className="text-3xl mb-4">Music Board</h1>
