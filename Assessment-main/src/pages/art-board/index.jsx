...
import { addArtResource, updateArtLike } from "../../store/slices/artBoardSlice";
...
function ArtBoard() {
  ...
  useEffect(() => {
    saveState("artBoard", board);
  }, [board]);

  const handleAddIdea = (e) => {
    e.preventDefault();
    dispatch(addArtResource({ ...newIdea, id: Date.now() }));
    setNewIdea({
      title: "",
      description: "",
      link: "",
  ...
  const handleLike = (id) => dispatch(updateArtLike(id));
  ...
  return (
    <div className="min-h-screen p-4">
      <h1 className="text-3xl mb-4">Art Board</h1>
