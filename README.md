...
- React: Chosen for its component-based architecture, which promotes reusability and maintainability (Codeur, 2024). Its vast ecosystem and strong community support make it an industry standard for building dynamic user interfaces.
- Vite: Selected as the build tool for its exceptional speed and developer-friendly experience, offering near-instant Hot Module Replacement (HMR) (DigitalOcean, 2025; DEV Community, 2024; TatvaSoft, 2024).
...
Version Control
The project follows Git best practices, including atomic commits, descriptive commit messages, and the use of feature branches to maintain a clean and stable main branch (GitLab, 2025; Nerdify Blog, 2025; Zemith, 2025).

Legal, Ethical, and Risk Considerations

- GDPR & Data Protection: The application handles user data such as emails and passwords. All passwords are encrypted in the database using the `werkzeug.security` library for hashing and salting, ensuring they are not stored in plaintext. This aligns with data protection best practices (AuditBoard, 2025; European Commission, 2025; GDPR Local, 2025).
...
AuditBoard. (2025). _The GDPR compliance framework: what you need to know in 2025_. [online] Available at: https://auditboard.com/blog/gdpr-compliance-framework.

Codeur, M. (2024). _Getting Started with React and Vite: The Complete Guide_. [online] 13 Dec. Available at: https://blog.mikecodeur.com/en/post/getting-started-with-react-and-vite-the-complete-guide.

DEV Community. (2024). _React + Vite: why use?_ [online] 10 Aug. Available at: https://dev.to/doccaio/react-vite-why-use-cg2.

DigitalOcean. (2025). _How To Set Up a React Project with Vite for Fast Development_. [online] 14 May. Available at: https://www.digitalocean.com/community/tutorials/how-to-set-up-a-react-project-with-vite.

European Commission. (2025). _Data protection_. [online] Available at: https://commission.europa.eu/law/law-topic/data-protection_en.

GDPR Local. (2025). _GDPR compliance for apps: a 2025 guide_. [online] Available at: https://gdprlocal.com/gdpr-compliance-for-apps/.

GitLab. (2025). _What are Git version control best practices?_ [online] Available at: https://about.gitlab.com/topics/version-control/version-control-best-practices/.

Nerdify Blog. (2025). _8 essential version control best practices for 2025_. [online] Available at: https://getnerdify.com/blog/version-control-best-practices/.

TatvaSoft Blog. (2024). _Vite vs Create-React-App: A Detailed Comparison_. [online] Jul. Available at: https://www.tatvasoft.com/outsourcing/2024/07/vite-vs-create-react-app.html.

Zemith. (2025). _8 version control best practices for teams in 2025_. [online] Available at: https://www.zemith.com/en/blogs/version-control-best-practices/.
